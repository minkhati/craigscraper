namespace :scraper do
  ...
  task scrape: :environment do
    ...
    auth_token = "39c78f752e51ccda0b5b0f46e2b7ddc0"
    ...
    loop do
      ...
      result["postings"].each do |posting|
        ...
        # Load over images and save to Image table
  ...
  desc "Save neighborhood codes in a refrence table"
